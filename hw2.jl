...
Almost all, because we used views into the existing array and broadcast assignment. At least one of the remaining 3 or so is for `img′`. 
"""
...
begin
	"""Pixel brightness as mean of RGB"""
...
Convolve `img` with kernel `k` using `imfilter` from `ImageFiltering`
"""
...
"""Negatives in red, positives in green."""
...
begin
	# raw docstring doesn't seem to work in Pluto
	"""Energy as magnitude of the gradient.
	
	For images, the gradient \$x\$ and \$y\$ components are estimated using the two Sobel filter kernels
	(equivalent to a 2nd-O centered finite difference).
	"""
...
# ╔═╡ 862565e0-f888-11ea-37f2-b9443348d306
...
# ╔═╡ 20405ba0-f88c-11ea-16db-7f0e9c90fc09
md" $n$: $(@bind n_fib Slider(1:30, show_value=true))"

# ╔═╡ 84cba570-f88c-11ea-3882-b9604f03eba2
md" $n$-th Fib: $(fib(n_fib - 1))"  # should start 1, 1, 2, 3 not 1, 2, 3
...
# ╔═╡ 7de89c50-0042-11eb-27d4-e381d58d2d90
energy(pika)

# ╔═╡ e5f8b400-002a-11eb-2add-2978a7730129
