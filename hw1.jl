...
# ╔═╡ 5aa25b50-f5ca-11ea-0aa3-f7f48ac64482
# dump(philip[1, 1])  # dumps internal repr to console
...
red_ = RGB(0.8, 0.1, 0.1)  # don't clobber red() from Images
...
The image is unrecognisable with intensity about 2
"""
...
"Take only every n-th pixel in either direction, by default 5"
...
channelview(philip[1, 1:2])  # note: doesn't work for single pixel

# ╔═╡ 5be9b144-ee0d-11ea-2a8d-8775de265a1d
mean_colors(philip)

# ╔═╡ 4f17f990-f5d2-11ea-06b3-13685d2eb898
floor(philip[1, 1].r, digits=1)

# ╔═╡ 5d57b320-f5d1-11ea-0673-6b64ea4159d3
floor.([philip[1, 1].r, philip[1, 1].g], digits=1)
...
# ╔═╡ fe385f30-f5e3-11ea-028f-c592849ed8f6
...
# ╔═╡ ab72d020-f5dc-11ea-302b-77b74d4ee232
...
@bind n_gauss_2d Slider(1:2:51, show_value=true)

# ╔═╡ 3ac076c0-f5e1-11ea-35a3-195192e2c2c1
@bind s_gauss_2d Slider(0.5:0.1:10.0, show_value=true)
...
# ╔═╡ d0987630-f5e5-11ea-20de-652124866b17
gauss_camera_image

# ╔═╡ 5e266840-f5e6-11ea-01b3-dd1421ec963b
with_gaussian_blur(gauss_camera_image)

# ╔═╡ bac82950-f5e4-11ea-1931-dd02dcd6b95f
with_sobel_edge_detect(gauss_camera_image)  # added

# ╔═╡ 573ded10-f5ea-11ea-1b20-db239ab20b1b
with_sobel_edge_detect(Gray.(red.(gauss_camera_image)))

# ╔═╡ 044a6c00-f5ea-11ea-216b-5775416c260d
with_sobel_edge_detect(Gray.(green.(gauss_camera_image)))

# ╔═╡ beb6af50-f5e9-11ea-0fd3-8329e9b4d5e1
with_sobel_edge_detect(Gray.(blue.(gauss_camera_image)))  # grayscale of blue only

# ╔═╡ 1ff6b5cc-ee19-11ea-2ca8-7f00c204f587
sobel_camera_image = Gray.(process_raw_camera_data(sobel_raw_camera_data));

# ╔═╡ 900fd73e-f5e3-11ea-0f3d-11c6ab9c9e7c
sobel_camera_image

# ╔═╡ 1bf94c00-ee19-11ea-0e3c-e12bc68d8e28
with_sobel_edge_detect(sobel_camera_image)  # full grayscale
